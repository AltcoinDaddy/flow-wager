...
export function getRestrictionMessage(countryCode?: string): string {
  const messages: Record<string, string> = {
    'US': 'Due to regulatory requirements, FlowWager is not available in the United States.',
    'CN': 'FlowWager is not available in China due to local regulations.',
    'default': 'FlowWager is not available in your region due to regulatory restrictions.'
  };
