...
const learnSections = [
  {
    id: "what-is-flowwager",
    title: "What Is FlowWager",
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        FlowWager is a decentralized binary prediction platform built on the
        Flow blockchain. Participants use FLOW tokens to express beliefs about
  ...
  },
  {
    ...
    content: (
      <ul className="list-none space-y-2 text-gray-300 text-sm leading-relaxed">
        ...
        <li>
          <span className="font-semibold text-gray-100">Stake FLOW:</span>{" "}
          Choose your side and stake FLOW tokens. Stakes are locked in a smart
        ...
        <li>
          ...
          The ratio of FLOW on each side indicates the market’s current
          consensus.
        </li>
        <li>
  ...
  {
    id: "why-use",
    title: "Why Use FlowWager",
    content: (
      <ul className="list-none space-y-2 text-gray-300 text-sm leading-relaxed">
        <li>
          <span className="font-semibold text-gray-100">Powered by FLOW:</span>{" "}
          Native utility for the Flow ecosystem.
        </li>
        <li>
          <span className="font-semibold text-gray-100">
        ...
        <li>
          ...
          FlowWager is a neutral protocol; it is not your counterparty.
        </li>
      </ul>
    ),
  },
    ...
    content: (
      <ul className="list-none space-y-2 text-gray-300 text-sm leading-relaxed">
        <li>
          ...
          prediction is incorrect, you may lose your staked FLOW tokens. Only
        ...
        <li>
          ...
          FlowWager is not available in the USA or jurisdictions that prohibit
        ...
        <li>
          ...
          FlowWager provides an information and education platform; it does not
  ...
  },
  {
    ...
    content: (
      <ul className="list-none space-y-2 text-gray-300 text-sm leading-relaxed">
        <li>
          <span className="font-semibold text-gray-100">
            Create a Flow Wallet:
          </span>{" "}
          Use a Flow-compatible wallet (e.g., Blocto, Lilico) and secure your
          seed phrase.
        </li>
        <li>
          <span className="font-semibold text-gray-100">
          ...
          Buy FLOW via an exchange or DEX and transfer them to your wallet.
        </li>
        <li>
          <span className="font-semibold text-gray-100">
            Connect to FlowWager:
          </span>{" "}
          Visit the platform and link your wallet.
        </li>
        <li>
          <span className="font-semibold text-gray-100">Explore Markets:</span>{" "}
          Browse active markets, choose an outcome, and stake FLOW.
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-gray-300 text-sm leading-relaxed">
          FlowWager distributes winnings using a proportional (pro-rata) model.
        ...
        <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <br />
          Total Pool: 1,000 FLOW | Platform Fee: 2% (20 FLOW) | Remaining Pool:
          980 FLOW
          <br />
          Outcome A (Winner): 400 FLOW | Outcome B (Loser): 600 FLOW
          <br />
          Alice stakes 100 FLOW on Outcome A → Alice’s share = 100 ÷ 400 = 25% →
          Payout = 25% × 980 = 245 FLOW
        </p>
          ...
          <table className="w-full text-sm text-gray-300 border-collapse">
            <thead>
              <tr className="bg-[#2a2c38] text-gray-100">
                ...
                <th className="p-2 text-left">Stake (FLOW)</th>
                <th className="p-2 text-left">Outcome Picked</th>
                <th className="p-2 text-left">Result</th>
                <th className="p-2 text-left">Payout (FLOW)</th>
                <th className="p-2 text-left">Profit (FLOW)</th>
              </tr>
            </thead>
            <tbody>
