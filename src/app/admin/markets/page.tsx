    ...
    try {
      ...
      switch (action) {
        ...
        case "cancel":
          ...
          if (confirm(`Are you sure you want to cancel ${marketIds.length} markets? This action cannot be undone.`)) {
            await new Promise(resolve => setTimeout(resolve, 2000));
        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-background border rounded-lg p-8 text-center max-w-sm w-full mx-4">
            ...
            <p className="text-muted-foreground">
              ...
              {!["export", "featured", "cancel"].includes(lastAction) && "Processing request..."}
            </p>
          </div>
        </div>
      )}
