...
const termsSections = [
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        FlowWager is a decentralized prediction platform built on the Flow
        blockchain. It allows users to participate in binary prediction markets.
        FlowWager is not a betting, gambling, or gaming service.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        ...
        jurisdiction) to use FlowWager. You may not use the platform if you are
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        Users must connect a Flow-compatible blockchain wallet to use FlowWager.
        You are solely responsible for safeguarding your wallet keys, passwords,
        and seed phrases. FlowWager cannot recover lost wallets or funds.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        Participation involves financial risk. You may lose FLOW tokens. Market
        conditions, smart contract issues, or blockchain malfunctions may impact
        your experience. You agree that you use FlowWager at your own risk.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        FlowWager does not provide financial, legal, tax, or investment advice.
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        To the maximum extent permitted by law, FlowWager and its affiliates are
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        You agree to indemnify and hold harmless FlowWager, its affiliates, and
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        FlowWager may update these Terms at any time. Updated Terms will be
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-300 text-sm leading-relaxed">
        FlowWager may suspend or terminate your access at any time for
