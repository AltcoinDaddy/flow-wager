    ...
    <div className="min-h-screen bg-[#0A0C14]">
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#1A1F2C] to-[#151923] rounded-2xl border border-gray-800/50 p-8">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
              <div className="flex items-center space-x-1">
                ...
                <Link
                  ...
                  className="text-[#9b87f5] hover:text-[#8b5cf6]"
                >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="bg-gradient-to-br from-[#1A1F2C] to-[#151923] border-gray-800/50">
              <CardHeader>
                <CardTitle className="text-white">Current Prices</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {userPosition && (
                  <div className="bg-[#0A0C14] rounded-lg p-4 border border-gray-800/50">
                    <h4 className="text-sm font-medium text-gray-400 mb-2">
                      Your Position
                    </h4>
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        <div className="text-[#9b87f5] font-medium">
            ...
            <Tabs defaultValue="activity" className="space-y-4">
              <TabsList className="grid w-full grid-cols-3 bg-[#1A1F2C] border border-gray-800/50">
                <TabsTrigger
                  value="activity"
                    ...
                    <div className="space-y-4">
                      {trades.length === 0 ? (
                        ...
                        trades.map((trade) => (
                          <div
                            key={trade.id}
                            className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-800/30"
                          >
                            <div className="flex items-center space-x-3">
                              <Badge
                                variant={
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center space-x-4 mt-2">
                                <button className="text-xs text-gray-400 hover:text-[#9b87f5]">
                                  {comment.likes} likes
                                </button>
                              </div>
                            </div>
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <Link
                      href={`/profile/${market.creator}`}
                      className="font-medium text-[#9b87f5] hover:text-[#8b5cf6]"
                    >
                      {market.creator.slice(0, 6)}...{market.creator.slice(-4)}
                    </Link>
            ...
            <Button
              ...
              variant="outline"
              className="w-full border-gray-700 text-gray-300 hover:bg-[#1A1F2C] hover:text-white hover:border-[#9b87f5]/50"
            >
              Refresh Data
            </Button>
          </div>
